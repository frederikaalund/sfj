#ifndef BLACK_LABEL_RENDERING_PROGRAM_HPP
#define BLACK_LABEL_RENDERING_PROGRAM_HPP
...
namespace interface {
	...
	extern const type shader_storage_block, uniform;
} // namespace interface
...
////////////////////////////////////////////////////////////////////////////////
	...
	program( const configuration& configuration )
		: core_program{black_label::rendering::generate}
	{
		setup(
